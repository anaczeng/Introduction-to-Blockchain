本章介绍了使用区块链技术较为瞩目的三个项目：以太坊、超级账本和公证链。以太坊是完全继承比特币去中心化性质并旨在将其发扬光大的公有链项目，它为去中心化的APP开发提供了基础设施和开发平台。若以太坊项目能顺利进入常态，普通用户将收回对自己数字资产的控制权：如何合理有效地管理个人数据资产将会是下一个热点议题。
